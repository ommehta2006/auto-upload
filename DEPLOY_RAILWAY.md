...
The database remains in the PostgreSQL service. The volume stores customer videos, thumbnails, caption files and failure screenshots. Railway trial/free storage is small, so use one short test video and delete it after testing.
...
7. Return to YouTubePilot and click **Save encrypted connection**.
